...
#查找颜值最高的老婆
print((IterableHepler.get_max(list_wifes,lambda item01,item02:item01.face_score < item02.face_score)).__dict__)
#根据老婆列表的颜值升序排序
IterableHepler.sort_up(list_wifes,lambda item01,item02:item01.face_score > item02.face_score)
for i in list_wifes:
    print(i.__dict__)